...
@Component({
  selector: 'app-traf-graph',
  templateUrl: './traf-graph.component.html',
  styleUrls: ['./traf-graph.component.scss']
})
export class TrafGraphComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    createChart() {
      ...
      this.chart = new Chart('MyChart5', config);
    };
