...
@Component({
  selector: 'app-prk-graph',
  templateUrl: './prk-graph.component.html',
  styleUrls: ['./prk-graph.component.scss']
})
export class PrkGraphComponent implements OnInit, OnChanges {
  ...
  creatLineChart() {
    ...
    this.chart = new Chart('MyChart3', config);
  }
